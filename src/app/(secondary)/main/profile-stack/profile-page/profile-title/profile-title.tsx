      ...
      <Header
        ...
        actions={[
          ...
          },
          {
            ...
            onClick: cycleTheme,
            ariaLabel: t('switch_theme'),
            title: t('switch_theme'),
          },
          {
            icon: (
              <svg width="22" height="22" fill="none" viewBox="0 0 26 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
