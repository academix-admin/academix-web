 ...
 // ✅ After
  ...
  return (
    <div className={`${styles.mainSection} ${styles[`mainSection_${theme}`]}`}>
      ...
      <div onClick={openRewardInfo} className={styles.infoIcon}>
        <svg className={`${styles.svgSection} ${styles[`svgSection_${theme}`]}`} fill="none" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-label="Infos">
            <path
