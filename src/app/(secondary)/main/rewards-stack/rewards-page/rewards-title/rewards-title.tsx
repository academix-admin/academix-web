 ...
 // ✅ After
  ...
  return (
    <Header
      ...
      theme={theme}
      title={t('reward_text')}
      description={t('surprises_awaits')}
      actions={[
        {
          icon: (
            <svg width="22" height="22" fill="none" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path
          ...
          onClick: openRewardInfo,
          ariaLabel: 'Rewards info',
        },
      ]}
    />
  );
