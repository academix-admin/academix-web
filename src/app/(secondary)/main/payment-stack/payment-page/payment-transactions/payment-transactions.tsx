              ...
              <div className={styles.historyItem}>
                <div className={styles.historyMain}>
                  ...
                  <div className={styles.amountContainer}>
                    <svg className={`${styles.currencyIcon} ${getStatusClass(transaction.transactionSenderStatus)}`} fill="none" height="98" viewBox="0 0 35 98" width="35" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <div className={styles.historyContent}>
                  <div className={styles.historyDetails}>
                    ...
                    <span
                      ...
                      className={`${styles.historyTime} ${getStatusClass(transaction.transactionSenderStatus)}`}
                    >
                      {capitalize(getTransactionStatus(transaction.transactionSenderStatus))}
                    </span>
                  </div>
                </div>
              </div>
