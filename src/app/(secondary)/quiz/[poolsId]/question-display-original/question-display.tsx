...
//     switch (displayType) {
//       case 'web': return styles.trueFalseButtonWeb;
//       case 'tablet': return styles.trueFalseButtonTablet;
//       case 'mobile':
//       default: return styles.mobileTrueFalseButton;
//     }
//   };
//
//   const getTextClass = () => {
...
//     switch (displayType) {
//       case 'web': return styles.multipleChoiceOptionWeb;
//       case 'tablet': return styles.multipleChoiceOptionTablet;
//       case 'mobile':
//       default: return styles.mobileMultipleChoiceOption;
//     }
//   };
//
...
//     switch (displayType) {
//       case 'web': return styles.sliderWeb;
//       case 'tablet': return styles.sliderTablet;
//       case 'mobile':
//       default: return styles.mobileSlider;
//     }
//   };
//
...
//   const getInputClass = () => {
//     switch (displayType) {
//       case 'web': return styles.fillGapInputWeb;
//       case 'tablet': return styles.fillGapInputTablet;
//       case 'mobile':
//       default: return styles.mobileFillGapInput;
//     }
//   };
//
//   return (
...
//
//   return (
//     <div className={styles.webQuizContainer}>
//       {/* Header */}
//       <div className={styles.webQuizHeader}>
...
//             <span className={styles.webQuestionCounter}>
//                {t('question_count', {x: getQuestionNumber(), y: totalNumber})}
//             </span>
//             <div className={styles.webQuestionType}>
...
//           <div className={styles.webTimeDisplay}>
//             <span className={styles.webRemainingText}>{t('remaining_time')}</span>
//             <span className={styles.webTimeValue}>{formatQuizTime(remainingTime)}</span>
//           </div>
...
//                 {getQuestionNumber()}
//               </span>
//               <h2 className={styles.webQuestionText}>
...
//
//         {/* Right Panel - Options */}
//         <div className={styles.webOptionsPanel}>
//           <div className={styles.webOptionsCard}>
...
//               </button>
//
//               <div className={styles.webProgressHint}>
...
//
//   return (
//     <div className={styles.tabletQuizContainer}>
//       {/* Header */}
//       <div className={styles.tabletQuizHeader}>
...
//             <span className={styles.tabletQuestionCounter}>
//                { t('question_counter_tab', {x: getQuestionNumber(), y: totalNumber})}
//             </span>
//             <div className={styles.tabletQuestionType}>
//               <QuestionTypeIcon type={question.typeData.questionTypeLocalIdentity} />
//               <span>{getQuestionTypeName(question.typeData.questionTypeLocalIdentity)}</span>
//             </div>
//           </div>
...
//           <div className={styles.tabletTimeDisplay}>
...
//             <h2 className={styles.tabletQuestionText}>
//               {question.questionData.questionsText}
//             </h2>
//           </div>
//         </div>
