...
CREATE OR REPLACE FUNCTION public.fetch_user_quiz_history(p_locale text, p_limit_by integer, p_after_histories jsonb, p_search_key text DEFAULT NULL::text)
 RETURNS SETOF jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
