-- schema:   public
-- function: fetch_top_up_methods(p_locale text, p_wallet_id uuid, p_limit_by integer, p_after_methods jsonb, p_user_id uuid, p_country text, p_gender text, p_age text)
-- generated from Supabase project iewqfmkngcgayxbbnpiz (read-only mirror)

CREATE OR REPLACE FUNCTION public.fetch_top_up_methods(p_locale text, p_wallet_id uuid, p_limit_by integer, p_after_methods jsonb, p_user_id uuid DEFAULT NULL::uuid, p_country text DEFAULT NULL::text, p_gender text DEFAULT NULL::text, p_age text DEFAULT NULL::text)
 RETURNS SETOF jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
