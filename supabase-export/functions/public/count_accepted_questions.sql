...
REVOKE EXECUTE ON FUNCTION public.count_accepted_questions(p_user_id uuid, p_topic_id uuid, p_locale text, p_country text, p_age text, p_gender text, p_status text, p_visible boolean, p_tracker_status text) FROM PUBLIC, anon;
