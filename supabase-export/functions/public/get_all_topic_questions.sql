...
REVOKE EXECUTE ON FUNCTION public.get_all_topic_questions(p_user_id uuid, p_country text, p_locale text, p_gender text, p_age text, p_limit_by integer, p_topic_id uuid, p_after_question text) FROM PUBLIC, anon;
