-- schema:   public
-- function: get_category_evaluation(p_category_id uuid, p_locale text)
-- generated from Supabase project iewqfmkngcgayxbbnpiz (read-only mirror)

CREATE OR REPLACE FUNCTION public.get_category_evaluation(p_category_id uuid, p_locale text)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
    ...
    WHERE
        (
            (SELECT permission_checker((SELECT translation::uuid FROM translate(tct.topic_category_created_by,p_locale)), v_user_id)) = TRUE
