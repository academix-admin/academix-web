...
CREATE OR REPLACE FUNCTION public.fetch_available_quizzes(p_locale text, p_type text, p_limit_by integer, p_after_quiz_topics jsonb, p_search_key text DEFAULT NULL::text)
 RETURNS SETOF jsonb
 LANGUAGE plpgsql
 STABLE
AS $function$
