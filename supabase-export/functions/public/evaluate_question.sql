-- schema:   public
-- function: evaluate_question(p_question_id uuid, p_approval_checker text)
-- generated from Supabase project iewqfmkngcgayxbbnpiz (read-only mirror)

CREATE OR REPLACE FUNCTION public.evaluate_question(p_question_id uuid, p_approval_checker text)
 RETURNS jsonb
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
    ...
    SET
        ...
        questions_reviewed_by = COALESCE(questions_reviewed_by, '{}'::JSONB) || jsonb_build_object(locale, v_user_id),
